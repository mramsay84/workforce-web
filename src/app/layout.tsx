    ...
    <html lang="en" className="dark">
      ...
      <body className="bg-[#050507] text-[#fdfdff] antialiased">
        ...
        */}
        ...
        <a
          href="#main-content"
          className="sr-only focus:not-sr-only focus:fixed focus:top-4 focus:left-4 focus:z-[200] focus:rounded-md focus:bg-[#4f46e5] focus:px-4 focus:py-2 focus:text-sm focus:font-semibold focus:text-white focus:outline-none focus:ring-2 focus:ring-white"
        >
